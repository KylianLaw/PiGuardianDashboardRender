...
AIO_USERNAME = os.getenv("ADAFRUIT_IO_USERNAME", cfg.get("ADAFRUIT_IO_USERNAME"))
AIO_KEY = os.getenv("ADAFRUIT_IO_KEY", cfg.get("ADAFRUIT_IO_KEY"))
NEON_DB_URL = os.getenv("NEON_DB_URL", cfg.get("NEON_DB_URL"))

DEVICE_FEEDS = {
    "buzzer": cfg.get("BUZZER_CONTROL_FEED", "buzzer_control"),
    "led_green": cfg.get("LED_FEEDS", {}).get("green"),
    "led_yellow": cfg.get("LED_FEEDS", {}).get("yellow"),
    "led_red": cfg.get("LED_FEEDS", {}).get("red"),
}

LCD_FEED = os.getenv("LCD_FEED", cfg.get("FEED_KEY", "LCD_display"))
